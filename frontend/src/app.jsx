    ...
    return (
        ...
        >
            ...
            {/* 
                ...
                3. Date -> DD-MM-YYYY 
                4. Treatment Description -> Could be dropdown or input text area to tell what the current treatment is for treating the patients 
                (
                    ex : 
                ...
                5. Cost of Treatment -> Rp. 200,000.00 (Input as 200000)
            */}
            <Formik
                initialValues={{
                    patient_name: "",
